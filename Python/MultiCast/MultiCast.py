...
def work_thread(cam, save_dir):
    ...
    while True:
        ...
        if None != stOutFrame.pBufAddr and 0 == ret:
            ...
            # Save the image
            image_path = os.path.join(save_dir, f"image_{stOutFrame.stFrameInfo.nFrameNum}.jpg")
...
if __name__ == "__main__":
    ...
    save_dir1 = r'C:\Users\Student\Documents\ASJO\2dscan\hikvision\multicast\camera1'
    save_dir2 = r'C:\Users\Student\Documents\ASJO\2dscan\hikvision\multicast\camera2'
